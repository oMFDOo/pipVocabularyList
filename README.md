...
<video width="1080" height="720" controls>
  <source src="./documents/단어_라디오_기본.mp4" type="video/mp4">
</video>
> 아닛! 단어장을 선택해서 라디오를 만들어준다구?

<br><br>

<video width="1080" height="720" controls>
  <source src="./documents/단어_라디오_생성.mp4" type="video/mp4">
</video>
 - 대본 생성에 OpenAI API가 들어서 5$ 정도만 구매해도 한참 씁니담... 이건 투자할 수 있짢어!
 - 단어를 고르고, 생성하기 누른 뒤 새로고침을 연타하세요!
 - 한글/영어/단어 아는게 많을 수록 가리는게 많을 것입니다...
